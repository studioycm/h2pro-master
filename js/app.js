...
function init() {
    ...
    // init section4 background image 1
    gsap.set(section4BgImage1, {
        opacity: 0,
        objectPosition: "0px 0px",
    });
    // init section2 svg background
    ...
    // setting section01 sticker panel timeline
    ...
    // setting section01 sticker panel sliding animation
    webinarStickerTL
    ...
    // section01 PanelToggle click event to toggle sticker panel sliding animation
    ...
    // section01 ContinueButton click event to scroll to section2
    ...
    // dropEl click event to scrolling to the next section
    ...
    // set the active ".section-wrap" with "active" class using IntersectionObserver
    ...
    // init the observers for all of the section-wrappers
    sectionWraps.forEach((section) => {
        if (section) {
            sectionWrapObserver.observe(section);
            console.log(section.id + " sectionWrap Intersection Observer");
        }
    });

    // set section1 timeline
    ...
    // set section1 clipPath drop shape using dropElHalfWidth for the curves, 
    // to be used in section1 clipping on exit animation
